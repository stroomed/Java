...
import museo.modelo.PanelDeControl;
...
public class ingreso extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        BtnIngreso.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        ...
        jLabel1.setText("Bienvenido al registro del Museo Inacap");
    ...
    private void BtnIngresoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnIngresoActionPerformed
        if(usuario.getText().equals("user") && contraseña.getText().equals("admin")){
            PanelDeControl iA = new PanelDeControl();
            iA.setVisible(true);
        }else{
