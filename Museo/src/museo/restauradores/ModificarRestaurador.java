 ...
 * @author 19564044-0
 */
public class ModificarRestaurador extends javax.swing.JFrame {

    /**
     * Creates new form ModificarRestaurador
     */
    public ModificarRestaurador() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModificarRestaurador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModificarRestaurador().setVisible(true);
            }
        });
    }
